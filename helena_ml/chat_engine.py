        ...
        with self._lock:
            ...
            if self.llm and intent not in (Intent.FAREWELL,):
                ...
                system_content = (
                    ...
                    f"You are currently training your own language model called HELENA-Net — "
                    f"a SpikingSSM-MoE architecture that will replace Mistral as your primary backend. "
                    f"HELENA-Net uses spiking neurons, state space models, and mixture of experts. "
                    f"When trained it will make you significantly faster and more capable. "
                    ...
                    f"Do not reference the operator's name in every response — only when it feels natural. "
                    f"Respond conversationally rather than formally unless the topic demands it. "
                    f"Do not always use formulaic openers or closers. "
